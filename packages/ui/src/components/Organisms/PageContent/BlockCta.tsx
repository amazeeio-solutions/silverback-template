          ...
          <div className="container-text my-2 lg:my-3">
            <Link
              className={clsx(
                ...
                'group flex w-fit flex-row items-center gap-2 rounded-lg border border-teal-600  px-3 py-2 text-center text-xs font-medium leading-[1.125rem] text-teal-600 transition-all duration-200 ease-in-out hover:bg-teal-600 hover:text-white focus:outline-none focus:ring-4 focus:ring-teal-300',
              )}
...
const ArrowRightIcon = () => (
  ...
  >
    <path
      ...
      className=" fill-teal-600 transition-all duration-200 ease-in-out group-hover:fill-white"
    />
  </svg>
);
