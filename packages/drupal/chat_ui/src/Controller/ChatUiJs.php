...
namespace Drupal\chat_ui\Controller;
...
final class ChatUiJs extends ControllerBase {
  ...
  public function serve() {
    ...
    $module_path = \Drupal::service('module_handler')->getModule('chat_ui')->getPath();
    ...
    try {
      ...
      \Drupal::logger('chat_ui')->error('JS minification failed: @message', ['@message' => $e->getMessage()]);
